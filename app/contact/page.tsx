...
import { FaInstagram, FaWhatsapp, FaEnvelope, FaLinkedin, FaGithub } from "react-icons/fa";
...
export default function ContactPage() {
  return (
    <div className="min-h-screen relative bg-black overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
